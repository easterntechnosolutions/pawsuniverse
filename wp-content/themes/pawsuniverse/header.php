...
<body <?php body_class('paws_body ' . $post_slug ); ?>>
		...
		<div id="global_header_top_section" class="global_header_top_section">
			<div class="container-fluid py-2 bg-white">
				<div class="row align-items-center">
					...
					<div class="col-md-4 col-12 text-md-start global_header_left_section">
						<div class="info-container">
							<div class="info-block">
								...
								<div class="text">
									<p>Enquiry</p>
									<a href="tel:<?php echo $globalHeader_enquiry_number; ?>" alt="<?php echo $globalHeader_enquiry_number; ?>" title="<?php echo $globalHeader_enquiry_number; ?>"><?php echo $globalHeader_enquiry_number; ?></a>
								</div>
							</div>
							...
							<div class="info-block">
								...
								<div class="text">
									<p>Location</p>
									<a href="#" alt="<?php echo $globalHeader_location; ?>" title="<?php echo $globalHeader_location; ?>"><?php echo $globalHeader_location; ?></a>
								</div>
							</div>
						</div>
					</div>
					...
					<!-- Center Section: Logo -->
					<div class="col-md-4 col-12 text-center header_center_logo_section">
					...
					<div class="col-md-4 col-12 text-md-end text-center global_header_right_section">
